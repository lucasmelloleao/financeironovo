    ...
    <body id="page-top">
                ...
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="{{ url('painel') }}">Restrito <span class="fa fa-sign-in">	</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
                ...
                <div class="item active">
                    <div class="container">
                        ...
                        <div class="carousel-image wow zoomIn">
                            <img src="img/cabecalho.png" alt="laptop"/>
                        </div>
                    </div>
        ...
        <section id="atividades">
            <div class="row">
                ...
                <br> <br>
                <div class="tabela" >
                    <table class="table-hover col-md-12 border-top ">
                        <tr>
                            <th>Data</th>
                            <th>Horário</th>
                            <th>Atividade</th>
                        ...
                        <tr>
                            <td>Terças-feiras</td>
                            <td>20h  às 21h30min</td>
                            <td>Grupo  de Estudos: <strong>O Livro dos Espíritos.</strong></td>
                        </tr>
                        <tr>
                            <td>Quartas-feiras</td>
                            <td>19h30min às 21h30min</td>
                            <td>Ensaios  do Coral Encanto.</td>
                        </tr>
                        <tr>
                            <td>Quintas-feiras</td>
                            <td>20h às 21h30min</td>
                            <td>Grupo  de Estudos: <strong>A Gênese.</strong></td>
                        </tr>
                        <tr>
                            <td>Sextas-feiras</td>
                            <td>18h30min  às 20h</td>
                            <td>Diálogo  Fraterno <em>(esclarecimento de dúvidas,  passes, atendimento fraterno).</em></td>
                        </tr>
                        <tr>
                            <td>Sábados   </td>
                            <td>16h  às 17h30min</td>
                            <td>Grupo  de Estudos:<strong> Aspectos Filosóficos da  Doutrina Espírita.</strong></td>
                        </tr>
                        <tr>
                            <td>Sábados   </td>
                            <td>20h  às 21h30min</td>
                        ...
                        <tr>
                            <td>1º  Domingo de cada mês</td>
                            <td>08h  às 12h</td>
                            <td>Palestra,  Evangelização Infantil, Almoço Fraterno, Atividades Assistenciais.</td>
                        </tr>
                        <tr>
                            <td>1º Domingo  de cada mês</td>
                            <td>09h  às 10h</td>
                            <td>Bazar  de Roupas, Calçados e Utilidades <em>(usados).</em></td>
                        </tr>
                        <tr>
                            <td>1º Domingo  de cada mês</td>
                            <td>20h  às 22h</td>
                            <td>O  Evangelho no Lar e Confraternização de Trabalhadores.</td>
                        </tr>
                        <tr>
                            <td>Todos os dias</td>
                            <td>18h</td>
                            <td>Refeição  Fraterna no Hospital Santa Casa.</td>
                        </tr>
                    </table>  
            ...
            <div class="container">
                <div class="row">
                    <div class=" text-center wow zoomIn">
                        ...
                        <img src="images/sem.jpg" style="margin-left:15px; margin-top:15px;"/>

                        <h3> <center>História</center></h3>
                        <span  class="testimonials-text"> <strong>
                        ...
                        <h2><center>Dados sobre a nossa Instituição</center></h2>
                        <ul>
                            <li><a href="documentos/Diretoria_2012-2014.pdf" target="_blank">Diretoria</a></li>
                            <li><a href="documentos/Estatuto.pdf" target="_blank">Estatuto</a></li>
                            <li><a href="documentos/Regimento_Interno.pdf" target="_blank">Regimento Interno</a></li>
                        </ul>
        ...
        <script src="{!! asset('js/cbpAnimatedHeader.js') !!}" type="text/javascript"></script>
