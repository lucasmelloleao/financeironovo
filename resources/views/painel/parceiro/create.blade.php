...
<form class="form" method="post"  action="{{route('parceiro.update', $parceiro->id)}}">
    {!! method_field('PUT') !!}
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <form class="form" method="post"  action="{{url('/painel/parceiro/store')}}">
                            @endif 
                            ...
                            <div class="form-group col-lg-6">
                                <input readonly type="text" name="id" class="form-control col-lg-6" value="{{$parceiro->id or old('id')}}" >
                            ...
                            <div class="col-lg-12"> 
                                <div class="form-group">
                                    <input type="text" name= "nome" placeholder="Nome da Parceiro" class="form-control" value="{{$parceiro->nome or old('nome')}}" >
                                </div>
                            </div>
