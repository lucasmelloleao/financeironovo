...
<form class="form" method="post"  action="<?php echo e(route('parceiro.update', $parceiro->id)); ?>">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <form class="form" method="post"  action="<?php echo e(url('/painel/parceiro/store')); ?>">
                            <?php endif; ?> 
                            ...
                            <div class="form-group col-lg-6">
                                <input readonly type="text" name="id" class="form-control col-lg-6" value="<?php echo e(isset($parceiro->id) ? $parceiro->id : old('id')); ?>" >
                            ...
                            <div class="col-lg-12"> 
                                <div class="form-group">
                                    <input type="text" name= "nome" placeholder="Nome da Parceiro" class="form-control" value="<?php echo e(isset($parceiro->nome) ? $parceiro->nome : old('nome')); ?>" >
                                </div>
                            </div>
