...
<form class="form" method="post"  action="<?php echo e(route('conta.update', $conta->id)); ?>">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <form class="form" method="post"  action="<?php echo e(url('/painel/conta/store')); ?>">
                            <?php endif; ?> 
                            ...
                            <div class="form-group col-lg-6">
                                <input readonly type="text" name="id" class="form-control col-lg-6" value="<?php echo e(isset($conta->id) ? $conta->id : old('id')); ?>" >
                            ...
                            <div class="col-lg-12"> 
                                <div class="form-group">
                                    <input type="text" name= "nome" placeholder="Nome da Conta" class="form-control" value="<?php echo e(isset($conta->nome) ? $conta->nome : old('nome')); ?>" >
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12"> 
                                <div class="form-group">
                                    <input type="text" name= "tipo" placeholder="Tipo da Conta" class="form-control" value="<?php echo e(isset($conta->tipo) ? $conta->tipo : old('tipo')); ?>" >
                                </div>
                            </div>
