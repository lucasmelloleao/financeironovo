<?php $__env->startSection('title', 'Despesareceita'); ?>
...
<?php if(isset($despesareceita)): ?> 

<form class="form" method="post"  action="<?php echo e(route('despesareceita.update', $despesareceita->id)); ?>">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <form class="form" method="post"  action="<?php echo e(url('/painel/despesareceita/store')); ?>">
                            <?php endif; ?> 
                            ...
                            <div class="form-group col-lg-6">
                                <input readonly type="text" name="id" class="form-control col-lg-6" value="<?php echo e(isset($despesareceita->id) ? $despesareceita->id : old('id')); ?>" >
                            ...
                            <div class="col-lg-12"> 
                                <div class="form-group">
                                    <input type="text" name= "nome" placeholder="Descrição da Conta" class="form-control" value="<?php echo e(isset($despesareceita->nome) ? $despesareceita->nome : old('nome')); ?>" >
                                </div>
                            </div>

                            <div class="col-lg-12"> 
                                <div class="form-group">
                                    <input type="text" name= "debcred" placeholder="D/C" class="form-control" value="<?php echo e(isset($despesareceita->debcred) ? $despesareceita->debcred : old('debcred')); ?>" >
                                </div>
                            </div>
